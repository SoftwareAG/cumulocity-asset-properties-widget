...
describe('AssetPropertiesViewService', () => {
  ...
  beforeEach(async () => {
    ...
    service = new AssetPropertiesViewService(c8yAlarmsMock, c8yEventsMock);
  });
  ...
  it('should get the alarms with status 200', async () => {
    // given
  ...
  it('should get the events with status 200', async () => {
    // given
